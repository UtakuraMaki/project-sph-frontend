  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="choose-order">
        ...
        <Pagination :pageNo="pageNo" :pageSize="pageSize" :total="total" :continues="continues" @switchPageNo="switchPageNo"></Pagination>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
